...
public class TourGroupsService : BaseService, ITourGroupsService
{
    public TourGroupsService(ISender mediator) : base(mediator)
    {
    }
    
    public Task<PaginationResponse<TourCategoryDto>> SearchAsync(SearchTourGroupsRequest request)
    {
