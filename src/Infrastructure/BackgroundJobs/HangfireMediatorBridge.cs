...
internal class HangfireMediatorBridge
{
    ...
    private readonly IMultiTenantStore<TravaloudTenantInfo> _tenantStore;
    private readonly IMultiTenantContextAccessor _tenantContextAccessor;
    private readonly ICurrentUserInitializer _currentUserInitializer;

    public HangfireMediatorBridge(IMediator mediator, IMultiTenantStore<TravaloudTenantInfo> tenantStore, IMultiTenantContextAccessor tenantContextAccessor, ICurrentUserInitializer currentUserInitializer)
    {
        _mediator = mediator;
