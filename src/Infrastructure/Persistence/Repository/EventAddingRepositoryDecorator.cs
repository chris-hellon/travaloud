    ...
    where T : class, IAggregateRoot
{
    ...
    {
        var aggregateRoots = entities as T[] ?? entities.ToArray();
        foreach (var entity in aggregateRoots)
        {
            entity.DomainEvents.Add(EntityCreatedEvent.WithEntity(entity));
        }

        return _decorated.AddRangeAsync(aggregateRoots, cancellationToken);
    }
    ...
    public Task UpdateRangeAsync(IEnumerable<T> entities, CancellationToken cancellationToken = default)
    {
        ...
        return _decorated.UpdateRangeAsync(aggregateRoots, cancellationToken);
    }
    ...
    public Task DeleteRangeAsync(IEnumerable<T> entities, CancellationToken cancellationToken = default)
    {
        ...
        return _decorated.DeleteRangeAsync(aggregateRoots, cancellationToken);
    }
