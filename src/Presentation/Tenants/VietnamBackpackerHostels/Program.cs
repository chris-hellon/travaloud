using VietnamBackpackerHostels.Configurations;
using Serilog;
...
try
{
    ...
    builder.Services.AddTenantWebsiteInfrastructure(builder.Configuration, builder.Environment,
        "VietnamBackpackerHostels");
