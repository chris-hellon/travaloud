...
public abstract class EntityTableContext<TEntity, TId, TRequest>
{
    ...
    /// Use this if you want to disable the update functionality for specific entities in the table.
    /// </summary>
    public Func<TEntity, bool>? CanViewEntityFunc { get; set; }
    ...
    public Func<TEntity, string>? EditNavigateTo { get; set; }

    public Func<string>? CreateNavigateTo { get; set; }
    ...
    public EntityTableContext(
        ...
        Func<TEntity, string>? editNavigateTo,
        Func<string>? createNavigateTo,
        string? viewAction,
        Func<TEntity, bool>? canViewEntityFunc)
    {
        ...
        SearchAction = searchAction ?? TravaloudAction.Search;
        CreateAction = createAction ?? TravaloudAction.Create;
        UpdateAction = updateAction ?? TravaloudAction.Update;
        DeleteAction = deleteAction ?? TravaloudAction.Delete;
        ExportAction = exportAction ?? TravaloudAction.Export;
        ViewAction = viewAction ?? TravaloudAction.View;
        ...
        CanViewEntityFunc = canViewEntityFunc;
        EditNavigateTo = editNavigateTo;
        CreateNavigateTo = createNavigateTo;
    }
