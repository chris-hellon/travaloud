...
namespace Travaloud.Admin.Components.Dialogs.WebsiteManagement.Tours.Suppliers;
...
public partial class PartnerContact : ComponentBase
{
    ...
    [Parameter] public EntityServerTableContext<PartnerDto, DefaultIdType, UpdatePartnerRequest> Context { get; set; } = default!;
