...
public partial class SupplierProfile
{
    ...
    private async Task UpdateSupplierDetails()
    {
        ...
        await ServiceHelper.ExecuteCallGuardedAsync(() => UsersService.UpdateAsync(request, Id), Snackbar, Logger, "Supplier Updated Successfully.");
    }
