...
namespace Migrators.SqlServer.Migrations.Application
{
    ...
    [Migration("20240218055542_PageModalLookups2")]
    partial class PageModalLookups2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Travaloud.API.Domain.Catalog.GeneralEnquiry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("GeneralEnquiries", "Catalog");

                    b.HasAnnotation("Finbuckle:MultiTenant", true);
                });

            modelBuilder.Entity("Travaloud.API.Domain.Catalog.Image", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Travaloud.API.Domain.Catalog.JobVacancyResponse", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("DestinationsVisited")
                        .IsRequired()
                        .HasMaxLength(500)
                    ...
                    b.Property<string>("EstimatedDates")
                        .IsRequired()
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");
                    ...
                    b.Property<string>("HowCanWeCollaborate")
                        .IsRequired()
                        .HasMaxLength(2000)
                    ...
                    b.ToTable("JobVacancyResponses", "Catalog");
                });
            ...
            modelBuilder.Entity("Travaloud.API.Domain.Catalog.PageModal", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("PageModals", "Catalog");
                });

            modelBuilder.Entity("Travaloud.API.Domain.Catalog.PageModalLookup", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("PageModalId");

                    b.ToTable("PageModalLookups", "Catalog");
                });
            ...
            modelBuilder.Entity("Travaloud.API.Domain.Catalog.Partner", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("Partners", "Catalog");

                    b.HasAnnotation("Finbuckle:MultiTenant", true);
                });

            modelBuilder.Entity("Travaloud.API.Domain.Catalog.PartnerContact", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("PartnerContacts", "Catalog");
            ...
            modelBuilder.Entity("Travaloud.API.Domain.Catalog.Property", b =>
                {
                    ...
                    b.Property<string>("MobileVideoPath")
                        .HasMaxLength(2048)
                        .HasColumnType("nvarchar(2048)");
            ...
            modelBuilder.Entity("Travaloud.API.Domain.Catalog.PropertyImage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Travaloud.API.Domain.Catalog.ServiceEnquiry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ServiceEnquiries", "Catalog");

                    b.HasAnnotation("Finbuckle:MultiTenant", true);
                });

            modelBuilder.Entity("Travaloud.API.Domain.Catalog.ServiceEnquiryField", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ServiceEnquiryFields", "Catalog");
                });
            ...
            modelBuilder.Entity("Travaloud.API.Domain.Catalog.TourEnquiry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("TourEnquiries", "Catalog");

                    b.HasAnnotation("Finbuckle:MultiTenant", true);
                });

            modelBuilder.Entity("Travaloud.API.Domain.Catalog.TourImage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Travaloud.API.Domain.Catalog.BookingItem", b =>
                {
                    b.HasOne("Travaloud.API.Domain.Catalog.Booking", "Booking")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("Travaloud.API.Domain.Catalog.Image", b =>
                {
                    b.HasOne("Travaloud.API.Domain.Catalog.Destination", null)
                        .WithMany("Images")
                        .HasForeignKey("DestinationId");

                    b.HasOne("Travaloud.API.Domain.Catalog.PropertyRoom", null)
                        .WithMany("Images")
            ...
            modelBuilder.Entity("Travaloud.API.Domain.Catalog.JobVacancyResponse", b =>
                {
                    b.HasOne("Travaloud.API.Domain.Catalog.JobVacancy", null)
                        .WithMany("Responses")
            ...
            modelBuilder.Entity("Travaloud.API.Domain.Catalog.PageModalLookup", b =>
                {
                    b.HasOne("Travaloud.API.Domain.Catalog.Page", "Page")
                        .WithMany("PageModalLookups")
                        .HasForeignKey("PageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Travaloud.API.Domain.Catalog.PageModal", "PageModal")
                        .WithMany("PageModalLookups")
                        .HasForeignKey("PageModalId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Page");

                    b.Navigation("PageModal");
                });
            ...
            modelBuilder.Entity("Travaloud.API.Domain.Catalog.PartnerContact", b =>
                {
                    b.HasOne("Travaloud.API.Domain.Catalog.Partner", null)
            ...
            modelBuilder.Entity("Travaloud.API.Domain.Catalog.ServiceEnquiry", b =>
                {
                    b.HasOne("Travaloud.API.Domain.Catalog.Service", "Service")
                        .WithMany()
            ...
            modelBuilder.Entity("Travaloud.API.Domain.Catalog.ServiceEnquiryField", b =>
                {
                    b.HasOne("Travaloud.API.Domain.Catalog.ServiceEnquiry", "ServiceEnquiry")
                        .WithMany("Fields")
