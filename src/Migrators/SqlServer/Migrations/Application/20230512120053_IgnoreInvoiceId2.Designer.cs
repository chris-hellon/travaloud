...
namespace Migrators.SqlServer.Migrations.Application
{
    ...
    [Migration("20230512120053_IgnoreInvoiceId2")]
    partial class IgnoreInvoiceId2
    {
            ...
            modelBuilder.Entity("Travaloud.API.Domain.Catalog.Booking", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("BookingReference"), 1L, 1);
